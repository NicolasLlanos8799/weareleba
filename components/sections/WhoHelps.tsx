      ...
      <div className={styles.inner}>
        ...
        <div className={styles.members}>
          {copy.members.map((member, index) => (
            <article
              className={`${styles.member} ${styles.reveal} ${index % 2 === 1 ? styles.memberRight : styles.memberLeft}`}
              key={member.name}
