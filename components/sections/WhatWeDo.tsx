...
type Copy = { heading: ReactNode; intro: string; learnMore: string; footer: string; exploreWork: string; services: Service[] };

const content: Record<"en" | "es", Copy> = {
  en: {
    heading: <>Digital solutions<br />to help grow<br />your business.</>,
    intro: "We design, build and automate digital tools that let you focus on what matters most: growing your business.", learnMore: "LEARN MORE", footer: "SAME PURPOSE. DIFFERENT PATHS.", exploreWork: "EXPLORE OUR WORK",
    services: [
  ...
  es: {
    ...
    intro: "Diseñamos, desarrollamos y automatizamos herramientas digitales para que puedas enfocarte en lo más importante: hacer crecer tu negocio.", learnMore: "SABER MÁS", footer: "MISMO PROPÓSITO. DIFERENTES CAMINOS.", exploreWork: "EXPLORA NUESTRO TRABAJO",
    services: [
