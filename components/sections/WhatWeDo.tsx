...
type Copy = { heading: ReactNode; intro: string; learnMore: string; footer: string; portfolioPrompt: string; exploreWork: string; sectionLabel: string; services: Service[] };

const content: Record<"en" | "es", Copy> = {
  en: { sectionLabel: "WHAT WE DO", heading: <>Digital solutions<br />to help grow<br />your business.</>, intro: "We design, build and automate digital tools that let you focus on what matters most: growing your business.", learnMore: "LEARN MORE", footer: "SAME PURPOSE. DIFFERENT PATHS.", portfolioPrompt: "This is what happens when ideas become real digital solutions.", exploreWork: "EXPLORE OUR WORK", services: [
  ...
  es: { sectionLabel: "QUÉ HACEMOS", heading: <>Soluciones digitales<br />para hacer crecer<br />tu negocio.</>, intro: "Diseñamos, desarrollamos y automatizamos herramientas digitales para que puedas enfocarte en lo más importante: hacer crecer tu negocio.", learnMore: "SABER MÁS", footer: "MISMO PROPÓSITO. DIFERENTES CAMINOS.", portfolioPrompt: "Esto es lo que ocurre cuando las ideas se convierten en soluciones digitales reales.", exploreWork: "EXPLORA NUESTRO TRABAJO", services: [
