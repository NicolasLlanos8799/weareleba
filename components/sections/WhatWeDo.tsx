...
const content: Record<"en" | "es", Copy> = {
  en: {
    ...
    portfolioPrompt: "This is what happens when ideas become real digital solutions.",
  ...
  es: {
    ...
    portfolioPrompt: "Esto es lo que ocurre cuando las ideas se convierten en soluciones digitales reales.",
