...
const content: Record<"en" | "es", Copy> = {
  en: {
    ...
    intro: "We design, build and automate digital tools that let you focus on what matters most: growing your business.", learnMore: "LEARN MORE", footer: "SAME PURPOSE. DIFFERENT PATHS.",
    services: [
  ...
  es: {
    ...
    intro: "Diseñamos, desarrollamos y automatizamos herramientas digitales para que puedas enfocarte en lo más importante: hacer crecer tu negocio.", learnMore: "SABER MÁS", footer: "MISMO PROPÓSITO. DIFERENTES CAMINOS.",
    services: [
